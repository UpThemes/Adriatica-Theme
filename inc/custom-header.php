...
function adriatica_custom_header_setup() {
	$args = array(
		...
		'height'                 => 80,
		'flex-height'            => true,
		'wp-head-callback'       => 'adriatica_header_style',
		'admin-head-callback'    => 'adriatica_admin_header_style',
		'admin-preview-callback' => 'adriatica_admin_header_image',
	);

	$args = apply_filters( 'adriatica_custom_header_args', $args );
...
add_action( 'after_setup_theme', 'adriatica_custom_header_setup' );
 ...
 *
 * @see adriatica_custom_header_setup().
 *
 * @since _s 1.0
 */
